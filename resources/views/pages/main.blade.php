<div class="group-container animate__animated animate__fadeInDown animate__durationExcluded" data-group="main">
    <div class="menu-buttons-group">
        <button class="group-navigate-btn btn btn-primary w-100 pt-4 mb-2" data-group="speech_to_code">
        ...
        <div class="d-flex justify-content-around gap-2 mb-2">
            <button class="group-navigate-btn btn btn-success w-100 pt-2" data-group="rooms">
            ...
            <button class="group-navigate-btn btn btn-danger w-100 pt-2" data-group="activities">
                <svg style="width: 24px; height: 24px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
